        ...
        <div ref={containerRef} style={{ opacity: open && !prefersReduced && !zenMode ? undefined : open ? 1 : 0 }}>
          ...
          <div className="flex flex-col gap-2 px-6 pb-6">
            ...
            <button
              type="button"
              onClick={onDismiss}
              className="relative btn-shine w-full overflow-hidden rounded-lg py-2 text-sm text-text-secondary hover:text-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-coral"
            >
              Maybe later
            </button>
          </div>
