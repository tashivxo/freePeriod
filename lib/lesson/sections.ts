...
export const LESSON_SECTIONS: readonly LessonSectionDef[] = [
  ...
  },
  {
    ...
    progressLabel: 'Prior knowledge',
    exportHeading: 'Prior Knowledge',
    showInView: true,
  },
  {
  ...
  {
    key: 'misconceptions',
    label: 'Possible Misconceptions',
    progressLabel: 'Possible misconceptions',
    exportHeading: 'Possible Misconceptions',
    showInView: true,
  },
  {
