...
export const ocrPack: CurriculumPack = {
  ...
  applicability: [
    'Use for OCR GCSE and OCR A-Level / AS planning language when OCR is the named board.',
    'Keep OCR visible in the planning context: this is not an AQA, Pearson Edexcel, Cambridge, or generic unnamed-board guide.',
    'OCR has different subject specifications, so use the current OCR specification that the school actually teaches for official course detail.',
    'Do not transfer assumptions from AQA, Pearson Edexcel, Cambridge International, or another school’s locally authored programme.',
  ],
  uiHelperText:
    'Guideline pack for OCR GCSE and A-Level planning language. Not official or verified. Not AQA, Edexcel, or Cambridge.',
  terminology: [
    'Guideline only. Name OCR as the board context, but never invent official identifiers, assessment labels, mark schemes, or course requirements.',
    'If an uploaded OCR specification exists, use only identifiers and terminology that appear in it; otherwise use plain-language knowledge, application, analysis, and evaluation.',
    'Use learning intention, success criteria, modelling, guided practice, independent application, retrieval, misconception, feedback, and reflection as practical OCR planning language.',
    'Use command words such as state, describe, explain, compare, analyse, and evaluate to shape classroom tasks when they suit the intended thinking; this is a practical selection, not a complete official list.',
    'Do not invent an OCR suite name or present a subject-family label as an official requirement; use the subject name supplied by the teacher.',
    ...
    'Describe OCR exam-style practice as preparation for communicating subject understanding, not as a substitute for teaching the underlying knowledge and skills.',
  ],
  assessmentStyle: [
    'Begin with a short retrieval or diagnostic check that reveals prerequisite knowledge, misconceptions, and language needs in the OCR subject context.',
    ...
    'Use OCR-aware exam-style practice when it serves the learning intention, but do not invent official scoring, identifiers, grade boundaries, or assessment materials.',
    'If an uploaded OCR specification exists, use only assessment language and identifiers that appear in it; otherwise assess knowledge, application, analysis, and evaluation in plain language.',
    'Keep practical, investigative, fieldwork, and extended-production activities as broad planning categories unless the supplied OCR specification provides official detail.',
    'Never use an invented suite name to justify a lesson sequence or claim that a generic activity is an OCR requirement.',
  ...
  lessonExpectations: [
    'Write a clear OCR GCSE or A-Level learning intention that identifies the knowledge, concept, skill, or method students should demonstrate by the end of the lesson.',
    'Pair it with concise success criteria describing visible performance and expected quality without inventing OCR course identifiers.',
    ...
    'Plan questioning from secure recall towards explanation, application, comparison, interpretation, analysis, or evaluation as appropriate for the subject and class.',
    ...
    'Include the lesson shape of learning intention, success criteria, modelling, guided practice, independent application, and OCR-aware exam-style practice only where it reinforces the learning intention.',
    'Use the teacher-supplied OCR subject specification to choose content; do not invent a suite name, prescribed sequence, or official task.',
  ...
  subjectNotes: {
    Mathematics: [
      ...
      'Use OCR as the board context while leaving the mathematical course sequence and official terminology to the supplied specification.',
    ],
    English: [
      ...
      'Plan reading and writing around the supplied OCR subject specification without inventing a suite name, set text, or official task.',
    ],
    Science: [
      ...
      'Treat practical and investigative work as planning categories unless the supplied OCR specification provides the official detail.',
    ],
    'Computer Science': [
      ...
      'Use OCR computer-science planning language without assigning an invented suite name or importing another board’s course structure.',
    ],
    History: [
      ...
      'Use the supplied OCR history specification for topic choices and sequencing; this pack does not create an official depth study or route.',
    ],
    Geography: [
      ...
      'Use OCR geography as the board context while leaving case studies, fieldwork, and official content choices to the supplied specification.',
    ],
  },
};
