...
export const adekPack: CurriculumPack = {
  ...
  applicability: [
    'Abu Dhabi. ADEK is the emirate’s education regulator, with a focus on school quality, compliance, educational standards, and inspection.',
    'Public schools still follow the national MOE curriculum; use this pack for the ADEK regulatory and quality lens, not as a replacement for MOE subject standards.',
    'Private schools may follow other approved curricula, so pair ADEK language with the school’s approved programme and internal policies.',
  ],
  uiHelperText:
  ...
  terminology: [
    ...
    'Use inspection-ready language such as learning impact, progress, participation, inclusion, evidence, consistency, and next steps when it accurately describes the lesson.',
    ...
    'Distinguish a school’s internal inspection or quality-assurance language from ADEK requirements unless the current ADEK policy explicitly confirms the requirement; do not turn inspection prompts into invented subject standards.',
  ],
  assessmentStyle: [
    ...
    'Make the evidence trail clear enough to support discussion of progress, learning impact, and the next teaching response during school review or inspection.',
  ...
  lessonExpectations: [
    'Identify the approved curriculum objective or school learning intention and write it as a measurable student performance; ADEK language should add the quality lens, not replace that curriculum objective.',
    ...
    'Make teacher questioning, student talk, checks for understanding, likely misconceptions, and the response to evidence visible so an observer can see how learning and progress are monitored.',
    ...
    'Keep resources, timings, safety, transitions, and student roles explicit enough that the lesson can be delivered consistently, reviewed afterwards, and discussed in terms of learning impact.',
