...
export const cambridgeALevelPack: CurriculumPack = {
  ...
  terminology: [
    'Name the current Cambridge International AS or A Level subject and use the school-supplied syllabus as teacher context when setting the learning intention; do not invent course details.',
    ...
    'Distinguish AS foundations from A2 depth using the current course context, increasing abstraction, complexity, independence, and evaluation without inventing specification details.',
    'Build synoptic reasoning by asking students to connect concepts, evidence, methods, and consequences across topics when those connections deepen understanding.',
    'Treat independent study as a supported progression: set a purposeful question or product, clarify sources and time expectations, and require students to reflect on what they can now explain or apply.',
  ],
  assessmentStyle: [
    ...
    'Include exam-style practice when it prepares students to apply the current learning, but do not invent mark schemes, grade boundaries, or official scoring rules.',
  ...
  lessonExpectations: [
    ...
    'Support EAL and ESL learners with pre-taught academic and subject vocabulary, clear instructions, visual or worked models, structured talk, and writing frames while maintaining AS or A2 depth.',
    ...
    'Plan independent study that extends the lesson with a clear question, product, or application, and close with reflection, synthesis, or exit evidence that informs the next lesson, intervention, or extension.',
  ],
  subjectNotes: {
    Mathematics: [
