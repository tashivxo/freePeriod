...
export const cambridgeIgcsePack: CurriculumPack = {
  ...
  authority: 'CAMBRIDGE',
  displayName: 'Cambridge IGCSE — Guideline Pack',
  coverage: 'guideline',
  ...
  applicability: [
    'Use for international schools planning with Cambridge IGCSE language and lesson structures.',
  ...
  terminology: [
    'Name the current Cambridge IGCSE subject syllabus supplied by the school when setting the learning intention; do not invent a syllabus reference or outcome code.',
  ...
  assessmentStyle: [
    ...
    'Use exam-style practice when it serves the learning intention, but do not invent mark schemes, grade boundaries, paper structures, or official scoring rules.',
  ...
  lessonExpectations: [
    ...
    'Include a meaningful independent or collaborative product and an exam-style or real-world application only when it reinforces the learning intention.',
